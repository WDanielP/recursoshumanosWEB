...
<div class="container" style="text-align: center;">
	<button class="btn btn-primary" onclick="window.location.href='/ismac-recursos-web-nocturnov2/empleados/findOne?opcion=1'; return false;"><i class="fa-solid fa-user-plus"></i> Agregar
					</button>
</div>
...
<thead>
				...
				<th data-field="idCiudad" data-sortable="true" > Ciudad</th>
...
<td><img alt="foto"  height="100" width="100" src="${pageContext.request.contextPath}/resources/img/${item.foto}">${item.foto}</td>

					
					
					
					<td>
					<button class="btn btn-success" onclick="window.location.href='/ismac-recursos-web-nocturnov2/empleados/findOne?idEmpleado=${item.idEmpleado}&opcion=1'; return false;"><i class="fa-solid fa-rotate"></i>
					</button>
	
					<button class="btn btn-danger" onclick="window.location.href='/ismac-recursos-web-nocturnov2/empleados/findOne?idEmpleado=${item.idEmpleado}&opcion=2'; return false;"><i class="fa-solid fa-trash"></i>
					</button>
